...
void pgma_read ( std::string input_name, int &xsize, int &ysize, int &maxg, int **g )
...
void pgma_read_data ( std::ifstream &input, int xsize, int ysize, int *g )
...
void pgma_read_header ( std::ifstream &input, int &xsize, int &ysize, int &maxg )
...
void pgma_read_test ( std::string input_name )
...
void pgma_write ( std::string output_name, int xsize, int ysize, int *g )
...
void pgma_write_data ( std::ofstream &output, int xsize, int ysize, int *g )
...
void pgma_write_header ( std::ofstream &output, std::string output_name, int xsize, 
  int ysize, int maxg )
...
void pgma_write_test ( std::string output_name )
