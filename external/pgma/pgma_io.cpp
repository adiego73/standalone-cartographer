...
void
pgma_check_data(int xsize, int ysize, int maxg, int *g)
...
void
pgma_example(int xsize, int ysize, int *g)
...
void
pgma_read(std::string input_name, int &xsize, int &ysize, int &maxg, int **g)
...
//  Parameters:
//
//    Input, std::string INPUT_NAME, the name of the file.
//
...
void
pgma_read_data(std::ifstream &input, int xsize, int ysize, int *g)
...
//  Parameters:
//
//    Input, std::ifstream &INPUT, a pointer to the file containing the data.
//
//    Input, int XSIZE, YSIZE, the number of rows and columns of data.
//
//    Output, int *G, the array of XSIZE by YSIZE data values.
...
void
pgma_read_header(std::ifstream &input, int &xsize, int &ysize, int &maxg)
...
//  Parameters:
//
//    Input, std::ifstream &INPUT, a pointer to the file.
//
//    Output, int &XSIZE, &YSIZE, the number of rows and columns of data.
//
//    Output, int &MAXG, the maximum gray value.
...
void
pgma_read_test(std::string input_name)
...
void
pgma_write(std::string output_name, int xsize, int ysize, int *g)
...
//  Parameters:
//
//    Input, std::string OUTPUT_NAME, the name of the file.
//
//    Input, int XSIZE, YSIZE, the number of rows and columns of data.
//
//    Input, int *G, the array of XSIZE by YSIZE data values.
...
void
pgma_write_data(std::ofstream &output, int xsize, int ysize, int *g)
...
//  Parameters:
//
//    Input, std::ofstream &OUTPUT, a pointer to the file.
//
//    Input, int XSIZE, YSIZE, the number of rows and columns of data.
//
...
void
pgma_write_header(std::ofstream &output, std::string output_name, int xsize, int ysize, int maxg)
...
void
pgma_write_test(std::string output_name)
...
//  Purpose:
//
//    S_LEN_TRIM2 returns the length of a std::string to the last nonblank.
//
//  Licensing:
//
//    This code is distributed under the GNU LGPL license.
...
//
//    Output, int S_LEN_TRIM2, the length of the std::string to the last nonblank.
//    If S_LEN_TRIM2 is 0, then the std::string is entirely blank.
//
{
    int n;
...
void
s_word_extract_first(std::string s, std::string &s1, std::string &s2)

//****************************************************************************80
//
//  Purpose:
//
//    S_WORD_EXTRACT_FIRST2 extracts the first word from a std::string.
//
//  Discussion:
//
//    A "word" is a std::string of characters terminated by a blank or
...
//  Parameters:
//
//    Input, std::string S, the std::string.
//
//    Output, std::string &S1, the first word (initial blanks removed).
//
//    Output, std::string &S2, the remainder of the std::string, after removing
